...
[All records](../README.md) · [HTML reading copy](../cases/bronte-jane-eyre-1b7a31e3fd7655f5.html)
...
Jane uses “I love you” as a direct, reason-giving avowal of her loving state: it explains why she welcomes the prospect of living with Rochester. The surrounding engagement gives the statement relational significance, but the core clause does not itself undertake or renew a commitment. Its measured placement in an extended explanation supplies no independent expressive/reflexive force.

## Ambiguity

The imminent marriage gives the avowal a weak commitment-adjacent coloration, but the undertaking is expressed by the surrounding plans and promises rather than by the core love clause.

## Narrative situation (AI interpretation)

Jane is answering Rochester’s suspicion that she fears their new life together. She contrasts that concern with her happiness and presents love as the reason she hopes to live with him. Her refusal of immediate caresses—“let me talk undisturbed”—and the extended, orderly account frame the utterance as explanatory testimony rather than reflexive discharge. The later descriptions of gathering unease and a dreamed barrier add foreboding without altering the core avowal’s force.
...
The causal construction explicitly presents love as a true emotional state explaining Jane’s welcomed future with Rochester, strongly supporting T.

### e2 — local text

> “No, sir, don’t caress me now—let me talk undisturbed.”

Jane prioritizes a sustained verbal explanation over immediate affectionate interaction, weighing against treating the words as an expressive/reflexive discharge.

### e3 — local text

> Rochester asks whether Jane is apprehensive about “the new sphere” and future married life; Jane answers no before explaining the preceding day.

The utterance functions as a considered answer and reason-giving avowal. The marital context supplies relational stakes but does not make the core clause independently performative.

### e4 — local text

> Jane recounts thinking calmly and extensively about Rochester, their prospective life, and her happiness before narrating later anxiety and dreams of separation.

The reflective narrative setting supports a deliberate avowal and contextual foreboding, not an involuntary verbal response.

## Background, status and source records

Utterance status: **direct**. Jane directly addresses Rochester; the love utterance appears as a subordinate reason clause within her spoken explanation.
