...
[All records](../README.md) · [HTML reading copy](../cases/lawrence-women-in-love-ad55b92cc889a120.html)
...
Birkin directly avows as true that he has loved Gerald. The perfect construction presents love as a state extending through some prior interval, while “don’t forget” turns the avowal into a bitter reminder or reproach. It does not itself undertake a future commitment, and the bitter delivery supplies no independent evidence of expressive/reflex-like discharge.

## Ambiguity

Gerald immediately questions whether Birkin truly loved him, creating uncertainty about sincerity or self-knowledge rather than about the utterance’s predominantly truth-conditional force. The elliptical scope of “as well as Gudrun” is somewhat ambiguous but does not alter the core classification.

## Narrative situation (AI interpretation)

Birkin interrupts Gerald’s entranced account of his destructive relationship with Gudrun by bitterly reminding him of Birkin’s own love. The utterance asserts a neglected emotional fact and implicitly reproaches Gerald for overlooking their bond. Gerald’s icy response—“Have you? Or do you think you have?”—challenges the avowal’s truth or Birkin’s self-understanding, but does not convert it into a performative undertaking or expressive reflex.
...
The explicit perfect-form avowal strongly supports truth-conditional force; “don’t forget” frames it as a reminder and reproach, while “bitterly” describes delivery without independently establishing E.

### e2 — local text

> Gerald replies, “Have you? Or do you think you have?” with “icy scepticism.”

Gerald treats Birkin’s words as a claim about Birkin’s loving state whose truth or self-knowledge can be challenged, reinforcing T.

### e3 — local text

> Immediately beforehand, Gerald speaks at length about Gudrun and his extreme, destructive experience with her.

Birkin’s avowal functions contextually as a pointed reminder that his love for Gerald has been ignored amid Gerald’s fixation on Gudrun.

### e4 — supplied metadata

> The supplied form analysis identifies an affirmative perfect construction.

The grammatical form is consistent with an avowal that presents prior or continuing love as true, rather than a promise or reflexive ejaculation.

## Background, status and source records

Utterance status: **direct**. Birkin directly addresses Gerald: “I’ve loved you, as well as Gudrun, don’t forget.”
