...
[All records](../README.md) · [HTML reading copy](../cases/eliot-middlemarch-dfd8012ac3e53026.html)
...
Mary’s clause “even if I did love you” introduces love as a hypothetical concession rather than asserting or avowing that she loves Fred. It therefore has only weak truth-conditional support. It neither undertakes a commitment nor functions as an affective verbal discharge.

## Ambiguity

The surrounding exchange may suggest that Mary is withholding or indirectly concealing genuine love, but this pragmatic possibility does not turn the conditional clause itself into a direct avowal.

## Narrative situation (AI interpretation)

Fred presses Mary to say that she loves him and to promise marriage. Mary instead separates the two issues: even granting love hypothetically, she considers marriage to an idle, indebted man morally wrong. Her wording may strategically avoid disclosing her feelings, but its immediate force is conditional argument rather than confession, commitment, or reflexive expression.
...
The “even if” construction marks the love proposition as a hypothetical concession, not an asserted avowal.

### e2 — local text

> Fred says, “If you love me, you ought to promise to marry me,” and Mary answers by denying that love would justify marriage.

The utterance occurs in an argument about whether love entails a marital promise; Mary herself makes no relational undertaking.

### e3 — local text

> Earlier Mary says, “If I did love you, I would not marry you: I would certainly not promise ever to marry you.”

The repeated conditional framing confirms deliberate hypothetical reasoning and explicit refusal of commitment.

### e4 — supplied metadata

> The occurrence is identified in Chapter XIV as an embedded past-form explicit love expression.

Confirms the selected occurrence and its embedded grammatical form.

## Background, status and source records

Utterance status: **hypothetical**. Mary directly speaks the embedded conditional clause “even if I did love you,” entertaining love for Fred without affirming it.

Background knowledge reported as used: **False**. 

Self-reported confidence: 0.96. Not a calibrated accuracy estimate.

Ontology fit: natural. T/P/E adequately represents the core force when combined with the hypothetical utterance status: there is weak presentation of a loving-state proposition but no avowal, undertaking, or expressive discharge. No residual core-force dimension requires O.

- [Saved input](https://github.com/mannyrayner/let_me_count_the_ways/blob/ef7ea7933d8aa02b176d8fbddc496e55a41a7144/results/annotation/canonical_31_v0_11_v0_3_1/annotations/eliot-middlemarch-dfd8012ac3e53026/a42c0301ccfd86685c735a937bce09f57b44d6fad9cf3804b5c5e095c6a5fe1c/request.json)
- [Saved annotation](https://github.com/mannyrayner/let_me_count_the_ways/blob/ef7ea7933d8aa02b176d8fbddc496e55a41a7144/results/annotation/canonical_31_v0_11_v0_3_1/annotations/eliot-middlemarch-dfd8012ac3e53026/a42c0301ccfd86685c735a937bce09f57b44d6fad9cf3804b5c5e095c6a5fe1c/output.json)
...
- Occurrence: eliot-middlemarch-dfd8012ac3e53026
- Model: gpt-5.6-sol
