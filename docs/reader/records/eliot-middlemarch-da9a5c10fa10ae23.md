...
[All records](../README.md) · [HTML reading copy](../cases/eliot-middlemarch-da9a5c10fa10ae23.html)
...
Mary embeds the loving-state proposition in a hypothetical antecedent rather than avowing it as true. The utterance neither undertakes a relationship nor functions as an affective verbal discharge; indeed, it explicitly separates possible love from any promise of marriage.

## Ambiguity

The counterfactual-sounding wording may pragmatically suggest that Mary denies loving Fred, or may allow her to conceal feelings, but it does not assert either interpretation.

## Narrative situation (AI interpretation)

Fred asks Mary to say that she loves him and promise marriage. Mary refuses the requested encouragement by arguing that even love would not justify marrying an idle, indebted man. Her formulation is therefore a hypothetical rebuttal to Fred’s attempt to connect affection with marital obligation, not a straightforward confession. Her reddening and Fred’s belief that she cares may create interpersonal ambiguity, but they do not change the core hypothetical force.
...
The conditional construction makes the loving state hypothetical and explicitly rejects promissory or marital force.

### e2 — local text

> Fred asks Mary to say that she loves him and to promise to marry him; Mary answers with the highlighted conditional.

Mary declines rather than performs the avowal and commitment Fred solicits.

### e3 — local text

> Mary later repeats that it would be wicked to marry Fred “even if I did love you.”

The repeated concessive hypothetical confirms that her point is the independence of possible love from a marriage undertaking.

### e4 — local text

> Mary refuses “any encouragement,” while reddening; Fred remains persuaded that she “really did care for him.”

There is contextual uncertainty about Mary’s actual feelings, but no direct truth-conditional avowal in the classified occurrence.

## Background, status and source records

Utterance status: **hypothetical**. Mary directly utters the phrase as the antecedent of “If I did love you,” entertaining rather than asserting the loving state.

Background knowledge reported as used: **False**. 

Self-reported confidence: 0.96. Not a calibrated accuracy estimate.

Ontology fit: natural. The low T score captures an entertained loving-state proposition without an avowal, while zero P and E capture the absence of undertaking and expressive discharge. Hypothetical embedding is adequately recorded by utterance status and context, so it creates no residual pressure for O.

- [Saved input](https://github.com/mannyrayner/let_me_count_the_ways/blob/7eb1dbb/results/annotation/canonical_31_v0_11_v0_3_1/annotations/eliot-middlemarch-da9a5c10fa10ae23/90b4631af4c322e9416dd4dbc176c9b9b841c9d56498d9e7a4fabcc3f8120775/request.json)
- [Saved annotation](https://github.com/mannyrayner/let_me_count_the_ways/blob/7eb1dbb/results/annotation/canonical_31_v0_11_v0_3_1/annotations/eliot-middlemarch-da9a5c10fa10ae23/90b4631af4c322e9416dd4dbc176c9b9b841c9d56498d9e7a4fabcc3f8120775/output.json)
...
- Occurrence: eliot-middlemarch-da9a5c10fa10ae23
- Model: gpt-5.6-sol
