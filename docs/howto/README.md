...
| 15 | [Ingest and verify the indie-romance sources](15_ingest_indie_romance_three.md) | Preserved purchased ebooks, reproducible derived text, and reviewed rights/provenance records |
| 16 | [Extract and annotate the indie-romance pilot](16_annotate_indie_romance_three.md) | Reviewed extraction inventory and complete audited v0.3.1 pilot batch |
| 17 | [Report and compare the pilot](17_report_and_compare_indie_romance.md) | Indie inspection report and descriptive canonical-versus-indie comparison |
