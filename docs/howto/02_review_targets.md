# Step 2: review and approve targets

Run this only after we have reviewed the Step 1 response together. The AI output
...
specific, clearly reusable edition for the acquisition trial before Step 3.
